...
ActiveRecord::Schema.define(version: 20180105085145) do
  ...
  create_table "inventory_stock_entries", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "product_variants", "product_products", column: "product_id"
end
